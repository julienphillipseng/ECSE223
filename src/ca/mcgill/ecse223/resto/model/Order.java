...
public class Order implements Serializable
{
  ...
  private TakeOutCustomer takeOutCustomer;
  ...
  public TakeOutCustomer getTakeOutCustomer()
  {
    return takeOutCustomer;
  }

  public boolean hasTakeOutCustomer()
  {
    boolean has = takeOutCustomer != null;
    return has;
  }
  ...
  public boolean setTakeOutCustomer(TakeOutCustomer aNewTakeOutCustomer)
  {
    boolean wasSet = false;
    if (takeOutCustomer != null && !takeOutCustomer.equals(aNewTakeOutCustomer) && equals(takeOutCustomer.getOrder()))
    {
      //Unable to setTakeOutCustomer, as existing takeOutCustomer would become an orphan
      return wasSet;
    }

    takeOutCustomer = aNewTakeOutCustomer;
    Order anOldOrder = aNewTakeOutCustomer != null ? aNewTakeOutCustomer.getOrder() : null;

    if (!this.equals(anOldOrder))
    {
      if (anOldOrder != null)
      {
        anOldOrder.takeOutCustomer = null;
      }
      if (takeOutCustomer != null)
      {
        takeOutCustomer.setOrder(this);
      }
    }
    wasSet = true;
    return wasSet;
  ...
  public void delete()
  {
    ...
    TakeOutCustomer existingTakeOutCustomer = takeOutCustomer;
    takeOutCustomer = null;
    if (existingTakeOutCustomer != null)
    {
      existingTakeOutCustomer.delete();
    }
  }
  ...
  public String toString()
  {
    return super.toString() + "["+
            ...
            "  " + "takeOutCustomer = "+(getTakeOutCustomer()!=null?Integer.toHexString(System.identityHashCode(getTakeOutCustomer())):"null");
  }  
  //------------------------
